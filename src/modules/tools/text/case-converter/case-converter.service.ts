import type { CaseConverterInput, CaseConverterOutput } from './case-converter.schema.js'
...
export const sentenceCase = function (input: CaseConverterInput): CaseConverterOutput {
  return input.text
    .toLocaleLowerCase()
...
// Lower Case
export const lowerCase = function (input: CaseConverterInput): CaseConverterOutput {
  return input.text.toLocaleLowerCase()
}

// Upper Case
export const upperCase = function (input: CaseConverterInput): CaseConverterOutput {
...
export const capitalizeCase = function (input: CaseConverterInput): CaseConverterOutput {
  return (
    input.text
...
// Reverse text
export const reverseText = function (input: CaseConverterInput): CaseConverterOutput {
...
export const noDiacritics = function (input: CaseConverterInput): CaseConverterOutput {
